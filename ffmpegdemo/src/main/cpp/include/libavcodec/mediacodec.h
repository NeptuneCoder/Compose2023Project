...
/**
 * Allocate and initialize a MediaCodec codecContext.
 *
 * When decoding with MediaCodec is finished, the caller must free the
 * MediaCodec codecContext with av_mediacodec_default_free.
 *
...
/**
 * Convenience function that sets up the MediaCodec codecContext.
 *
 * @param avctx codec codecContext
 * @param ctx MediaCodec codecContext to initialize
...
/**
 * This function must be called to free the MediaCodec codecContext initialized with
