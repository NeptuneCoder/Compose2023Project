...
typedef struct AVCodecContext {
    ...
    /**
     * Private codecContext used for internal data.
     *
...
#define FF_DEBUG_NOMC        0x01000000
    ...
    /**
     * Legacy hardware accelerator codecContext.
     *
...
#define FF_THREAD_SLICE   2 ///< Decode more than one part of a single frame at once
     ...
     * The user may replace this with some multithreaded implementation,
     * the default implementation will execute the parts serially.
     * @param c codecContext passed also to func
     * @param count the number of things to execute
...
#define FF_CODEC_PROPERTY_FILM_GRAIN      0x00000004
     ...
     * codecContext fields store display dimensions (with the coded dimensions in
...
typedef struct AVHWAccel {
     ...
     *
     * @param avctx the codec codecContext
    ...
    /**
     * Fill the given hw_frames codecContext with current codec parameters. Called
...
/**
 * Free the codec codecContext and everything associated with it and write NULL to
 ...
 * codecContext. Any allocated fields in par are freed and replaced with duplicates
...
/**
 * Fill the codec codecContext based on the values from the supplied codec
 ...
 * function the codecContext has to be allocated with avcodec_alloc_context3().
 *
 ...
 * @endcode
 *
 * @param avctx The codecContext to initialize.
 * @param codec The codec to open this codecContext for. If a non-NULL codec has been
 *              previously passed to avcodec_alloc_context3() or
 *              for this codecContext, then this parameter MUST be either NULL or
 ...
 * codec codecContext (either open or closed). Opening and closing a codec codecContext
 ...
 *       before packets may be fed to the decoder.
 *
 * @param avctx codec codecContext
 ...
 *
 * @param avctx The codecContext which is currently calling get_format, and which
