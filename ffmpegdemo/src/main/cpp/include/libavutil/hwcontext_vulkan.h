...
/**
 * Main Vulkan codecContext, allocated as AVHWDeviceContext.hwctx.
 * All of these can be set before init to change what the codecContext uses
 */
typedef struct AVVulkanDeviceContext {
     ...
     * If supplying your own device codecContext, set this to an array of strings, with
     ...
     * If supplying your own device codecContext, these fields takes the same format as
 ...
 *
 * If all queue family indices in the device codecContext are the same,
