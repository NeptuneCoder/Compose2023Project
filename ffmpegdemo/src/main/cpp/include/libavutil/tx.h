 ...
 *
 * @note Using a different codecContext than the one allocated during av_tx_init()
 * is not allowed.
 *
 * @param s the transform codecContext
...
/**
 * Initialize a transform codecContext with the given configuration
 * (i)MDCTs with an odd length are currently not supported.
 *
 * @param ctx the codecContext to allocate, will be NULL on error
...
/**
 * Frees a codecContext and sets *ctx to NULL, does nothing when *ctx == NULL.
 */
